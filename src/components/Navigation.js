  ...
  return (
    <nav className='h-15vh p-8 fixed w-[100vw] bg-white md:p-5 md:flex md:items-center md: justify-between z-[1]'>
        ...
        <ul id='menu-list' className={`md:flex md:items-center z-[1] md:z-[4] md:static absolute bg-white w-full md:h-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 ${dropdownActive ? 'top-[100%] opacity-100': '-top-96 opacity-0'} transition-all ease-in duration-500`}>
            ...
            <li className={`mx-4 my-6 md:py-0 ${menuActive.project1 ? 'md:border-b-2 md:border-indigo-300' : ''}`}><a className='text-xl font-poppins hover:text-indigo-600 duration-200' href={'#project1-section'}>CV Creator</a></li>
            <li className={`mx-4 my-6 md:py-0 ${menuActive.project2 ? 'md:border-b-2 md:border-indigo-300' : ''}`}><a className='text-xl font-poppins hover:text-indigo-600 duration-200' href={'#project2-section'}>Weather App</a></li>
            <li className={`mx-4 my-6 md:py-0 ${menuActive.project3 ? 'md:border-b-2 md:border-indigo-300' : ''}`}><a className='text-xl font-poppins hover:text-indigo-600 duration-200' href={'#project3-section'}>Todo List</a></li>
