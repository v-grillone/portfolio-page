...
const AboutSection = ({ aboutRef }) => {
  ...
  return (
    <div ref={aboutRef} id="about-section" className='about-section md:px-16 px-4 md:py-4 h-85vh w-full bg-gradient-to-b from-indigo-300 to-indigo-100 flex flex-col items-center justify-around md:space-y-0 space-y-4'>
      <div className='technologies-section flex flex-col items-center w-full'>
        <h5 className='md:text-4xl text-3xl font-poppins uppercase tracking-wide'>Technologies</h5>
      ...
      <div className='introduction-container flex md:flex-row flex-col md:space-x-12 md:space-y-0 space-y-4 md:w-full w-[85%] max-h-72 md:mb-5 md:p-6 p-2 md:mb-6 items-center rounded bg-indigo-100 shadow'>
      ...
      <div className="hobbies-section flex flex-col space-y-8 items-center">
        <h5 className='md:text-4xl text-2xl font-poppins uppercase tracking-wide'>Interests & Hobbies</h5>
          ...
          <ul className='hobbies-icons-list flex flex-row list-none relative'>
            <li className={`absolute top-1/2 ${hobbiesIconPosition.icon1} transform -translate-x-1/2 -translate-y-1/2 `}>
              <div id="icon1" className={`${hobbiesIconPosition.icon1 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`}>
                <i className={`fa-solid fa-futbol text-4xl ${hobbiesIconPosition.icon1 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`}></i>
            ...
            <li className={`absolute top-1/2 ${hobbiesIconPosition.icon2} transform -translate-x-1/2 -translate-y-1/2 `}>
              <div className={`${hobbiesIconPosition.icon2 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`} id="icon2">
                <i className={`fa-solid fa-terminal text-4xl ${hobbiesIconPosition.icon2 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`}></i>
                <p>Coding</p>
              </div>
            </li>
            <li className={`absolute top-1/2 ${hobbiesIconPosition.icon3} transform -translate-x-1/2 -translate-y-1/2 `}>
              <div className={`${hobbiesIconPosition.icon3 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`} id="icon3">
                <i className={`fa-solid fa-hockey-puck text-4xl`}></i>
                <p>Hockey</p>
              </div>
            </li>
            <li className={`absolute top-1/2 ${hobbiesIconPosition.icon4} transform -translate-x-1/2 -translate-y-1/2 `}>
              <div className={`${hobbiesIconPosition.icon4 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`} id="icon4">
                <i className={`fa-solid fa-gamepad text-4xl ${hobbiesIconPosition.icon4 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`}></i>
                <p>Gaming</p>
              </div>
            </li>
            <li className={`absolute top-1/2 ${hobbiesIconPosition.icon4} transform -translate-x-1/2 -translate-y-1/2`}>
              <div className={`${hobbiesIconPosition.icon5 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`} id="icon5">
                <i className={`fa-solid fa-dumbbell text-4xl ${hobbiesIconPosition.icon5 === 'left-[50%]' ? 'opacity-1' : 'opacity-0'}`}></i>
                <p>Fitness</p>
              </div>
            </li>
          </ul>
